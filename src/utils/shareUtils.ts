...
앨범에 수록된 13곡의 사운드를 드래그 가능한 윈도우, 터미널 인터페이스, Winamp 스타일 플레이어로 경험할 수 있습니다. 데스크톱 아이콘을 클릭해 앨범 정보, 가사, 크레딧을 확인하고, 숨겨진 이스터에그를 발견해보세요. 캔버스 드로잉 도구로 직접 그림을 그리거나, 앨범 퀴즈를 통해 특별한 보상을 얻을 수 있습니다. 그리고 실제 고양이 울음 소리로 제작한 메트로놈이 유용하게 다가올 것입니다.
